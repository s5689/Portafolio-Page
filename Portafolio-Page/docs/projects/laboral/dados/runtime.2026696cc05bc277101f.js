!(function (e) {
  function r(r) {
    for (var n, i, a = r[0], c = r[1], l = r[2], p = 0, s = []; p < a.length; p++) (i = a[p]), o[i] && s.push(o[i][0]), (o[i] = 0);
  ...
  (i.e = function (e) {
    ...
    if (0 !== t)
      if (t) r.push(t[2]);
        ...
        (a.charset = 'utf-8'),
          ...
          (a.src = (function (e) {
            return (
              i.p + '' + ({ 0: 'npm.intl' }[e] || e) + '.' + { 0: 'bd8f19d9c7d9ab22c1c5', 12: 'e85530c1149c86b5e89e' }[e] + '.chunk.js'
            );
          })(e)),
          (u = function (r) {
    ...
    (i.p = '/Portafolio-Page/docs/projects/laboral/dados/'),
    (i.oe = function (e) {
